...
export default function Hero() {
  return (
    <section className="relative py-12 md:py-18">
      {/* Background glow */}
      <div
        className="pointer-events-none absolute -top-24 left-1/2 h-96 w-96 md:h-[450px] md:w-[450px] 
                   -translate-x-1/2 rounded-full 
                   bg-[radial-gradient(circle,rgba(var(--accent-primary),0.14)_0%,transparent_70%)]
                   blur-3xl"
      />
      ...
      >
        ...
        <div className="space-y-3 mt-3">
          <p className="text-base sm:text-lg md:text-xl font-semibold text-[rgb(var(--accent-primary))] flex items-center justify-center gap-2">
