      ...
      >
        <ul className="space-y-2.5 sm:space-y-3 text-slate-600 dark:text-slate-300">
          {ACTIVITIES.map((a, idx) => (
            <li key={idx} className="flex items-start gap-2.5 sm:gap-3 text-xs sm:text-sm leading-relaxed">
              <Sparkles className="mt-0.5 sm:mt-1 h-3.5 w-3.5 sm:h-4 sm:w-4 text-blue-600 dark:text-sky-400 shrink-0" />
              <span>{a}</span>
            </li>
          ))}
        </ul>
        ...
        <div className="mt-6 sm:mt-8 pt-4 sm:pt-6 border-t border-slate-200/80 dark:border-slate-800/80 grid grid-cols-1 sm:flex sm:flex-wrap items-center gap-2.5 sm:gap-3">
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="inline-flex items-center justify-center gap-2 rounded-xl border border-slate-200 dark:border-slate-700 bg-white/90 dark:bg-slate-800/90 px-4 py-2.5 text-xs sm:text-sm font-medium text-slate-800 dark:text-slate-200 hover:bg-blue-50 dark:hover:bg-slate-700/80 transition-all duration-200"
          >
          ...
          <a
            ...
            className="btn-accent inline-flex items-center justify-center gap-2 rounded-xl px-4 py-2.5 text-xs sm:text-sm font-medium text-white hover:scale-105 transition-transform duration-200 shadow-sm"
          >
